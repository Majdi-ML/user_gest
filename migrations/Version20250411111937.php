 ...
 */
final class Version20250411111937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_340597579D86650F ON depense');
        $this->addSql('ALTER TABLE depense CHANGE user_id_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depense CHANGE user_id user_id_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE depense ADD CONSTRAINT FK_340597579D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_340597579D86650F ON depense (user_id_id)');
    }
}
