 ...
 */
final class Version20260209141123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bureau (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, status_id INTEGER DEFAULT NULL, fonction_id INTEGER DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, telephone INTEGER DEFAULT NULL, annee_debut VARCHAR(4) NOT NULL, annee_fin VARCHAR(4) NOT NULL, CONSTRAINT FK_166FDEC46BF700BD FOREIGN KEY (status_id) REFERENCES status_bureau (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_166FDEC457889920 FOREIGN KEY (fonction_id) REFERENCES fonction_bureau (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE caisse (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, solde DOUBLE PRECISION NOT NULL, annee INTEGER DEFAULT NULL)');
        $this->addSql('CREATE TABLE cautionnement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, personne_id INTEGER DEFAULT NULL, appartement_id INTEGER DEFAULT NULL, user_id INTEGER DEFAULT NULL, montant_id INTEGER DEFAULT NULL, date_paiement DATE NOT NULL, mois VARCHAR(255) NOT NULL, nature_paiement VARCHAR(255) NOT NULL, annee VARCHAR(4) NOT NULL, CONSTRAINT FK_1585FA78A21BD112 FOREIGN KEY (personne_id) REFERENCES personne (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1585FA78E1729BBA FOREIGN KEY (appartement_id) REFERENCES appartement (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1585FA78A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1585FA781F8D148 FOREIGN KEY (montant_id) REFERENCES frais_syndic (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_1585FA781F8D148 ON cautionnement (montant_id)');
        $this->addSql('CREATE TABLE cnss (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, employe_id INTEGER DEFAULT NULL, trimstre INTEGER DEFAULT NULL, annee INTEGER NOT NULL, montant_totale DOUBLE PRECISION DEFAULT NULL, attached_file VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_87806B681B65292 FOREIGN KEY (employe_id) REFERENCES employe (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_87806B681B65292 ON cnss (employe_id)');
        $this->addSql('CREATE TABLE conge (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, employe_id INTEGER DEFAULT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, motif VARCHAR(255) DEFAULT NULL, attachedfile VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_2ED893481B65292 FOREIGN KEY (employe_id) REFERENCES employe (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_2ED893481B65292 ON conge (employe_id)');
        $this->addSql('CREATE TABLE depense (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, date_depense DATE NOT NULL, description VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, nature_depense VARCHAR(255) NOT NULL, attached_file VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_34059757A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_34059757A76ED395 ON depense (user_id)');
        $this->addSql('CREATE TABLE employe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fonction_employe_id INTEGER DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, cin INTEGER NOT NULL, salaire DOUBLE PRECISION DEFAULT NULL, cnss DOUBLE PRECISION NOT NULL, couverture_sociale BOOLEAN DEFAULT NULL, telephone INTEGER DEFAULT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, CONSTRAINT FK_F804D3B95095CE48 FOREIGN KEY (fonction_employe_id) REFERENCES fonction_employe (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE recette (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, date_recette DATE NOT NULL, description VARCHAR(255) NOT NULL, type_recette VARCHAR(255) NOT NULL, nature_recette VARCHAR(255) NOT NULL, attached_file VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_49BB6390A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
